...
latex_documents = [
  ('index', 'samos.tex', u'SAMoS documentation',
...
texinfo_documents = [
  ('index', 'samos', u'SAMoS documentation',
   author, 'samos', 'Suite for Analysis of Molecular Simulations',
   'Miscellaneous'),
]
