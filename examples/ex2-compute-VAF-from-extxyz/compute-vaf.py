...
from samos.plotting.plot_dynamics import plot_vaf_isotropic, plot_power_spectrum
...
def calculate_plot_vdos(traj):
    ...
    ax = fig.add_subplot(GridSpec(1,1, left=0.15, top=0.95, bottom=0.2, right=0.95)[0])
